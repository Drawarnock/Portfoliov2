(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        titles.forEach(title => title.classList.add('section__title--hidden'));
        ...
        window.addEventListener('scroll', function() {
            ...
            titles.forEach(title => {
                ...
                if(window.pageYOffset > titlesCoord.top - window.innerHeight) {
                    title.classList.remove('section__title--hidden');
                }
            });
    ...
    const stickyNav = () => {
        ...
        if(documentPosition > navOffset) nav.classList.add('navigation--sticky');
        else nav.classList.remove('navigation--sticky');
    }
